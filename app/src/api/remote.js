...
async function fetchProducts () {
  const res = await window.fetch(host + 'car/all')
  return res.json()
}

async function createProduct (data) {
  const res = await window.fetch(host + 'car/create', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
async function editProduct (id, data) {
  const res = await window.fetch(host + `car/edit/${id}`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': 'bearer ' + Auth.getToken()
...
async function deleteProduct (id) {
  const res = await window.fetch(host + `car/delete/${id}`, {
    method: 'DELETE',
    headers: {
      'Authorization': 'bearer ' + Auth.getToken()
    }
...
async function createReview (id, data) {
  const res = await window.fetch(host + `car/review/${id}`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': 'bearer ' + Auth.getToken()
...
async function likeProduct (id) {
  const res = await window.fetch(host + `car/like/${id}`, {
    method: 'POST',
    headers: {
      'Authorization': 'bearer ' + Auth.getToken()
    }
...
async function unlikeProduct (id) {
  const res = await window.fetch(host + `car/unlike/${id}`, {
    method: 'POST',
    headers: {
      'Authorization': 'bearer ' + Auth.getToken()
    }
